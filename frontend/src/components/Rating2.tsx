...
const Rating2: React.FC = () => {
  ...
  const { data: shops = [], refetch } = useQuery('shops', apiClient.fetchMyshops);
            ...
            {paginatedShops.map((shop:any) => {
              ...
              return (
                ...
                >
                  ...
                  <TableCell align="right">{shop?.starRating}</TableCell>
                  <TableCell align="right">{shop?.pricePerNight}</TableCell>
