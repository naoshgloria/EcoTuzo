      ...
      <div className="overflow-hidden bg-white border rounded-sm border-stroke shadow-default dark:border-strokedark dark:bg-boxdark">
        <div className="relative z-20 h-35 md:h-65">
          ...
          <div className="absolute z-10 bottom-1 right-1 xsm:bottom-4 xsm:right-4">
            <label
              htmlFor="cover"
              className="flex items-center justify-center gap-2 px-2 py-1 text-sm font-medium text-white rounded cursor-pointer bg-primary hover:bg-opacity-90 xsm:px-4"
            >
        ...
        <div className="px-4 pb-6 text-center lg:pb-8 xl:pb-11.5">
          ...
          <div className="mt-4">
            <h3 className="mb-1.5 text-2xl font-semibold text-green-950 dark:text-white">
              Danish Heilium
            </h3>
